...
let FinanceController = class FinanceController {
    ...
    getExpenses(month) { return this.financeService.findExpenses(month); }
    ...
    getProfitLoss(month) { return this.financeService.getProfitLoss(month); }
    getYearlySummary(year) { return this.financeService.getYearlySummary(parseInt(year)); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], FinanceController.prototype, "getYearlySummary", null);
